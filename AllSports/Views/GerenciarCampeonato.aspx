				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><button type="button" data-toggle="modal" data-target="#myModal"><i class="fa fa-search" style="font-size:24px"></i></button></td>
							<td><button type="button" data-toggle="modal" data-target="#myModal"><i class="fa fa-edit" style="font-size:24px"></i></button></td>
							<td><button type="button" data-toggle="modal" data-target="#myModal"><i class="fa fa-trash-o" style="font-size:24px"></i></button></td>
						</tr>
						<%
								cont = cont + 1;
							}

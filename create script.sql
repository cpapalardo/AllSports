...
create table tbCampeonato(
	...
	constraint fk_gerente_id foreign key (id_gerente) references tbJogador (id)
...
create table tbRodada(
	...
	constraint fk_campeonato_id foreign key (id_campeonato) references tbCampeonato (id)
)
...
create table tbTime(
	...
	constraint fk_coordenador_id foreign key (id_coordenador) references tbJogador (id)
)
...
create table tbPartida(
	...
	constraint fk_gerente__partida_id foreign key (id_gerente) references tbJogador (id),
